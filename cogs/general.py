...
class General:
    ...
    async def roll(self, ctx, number : int = 100):
        ...
        if number > 1:
            ...
            await self.bot.say("{} Lớn hơn 1 mới random được chứ má?".format(author.mention))
    ...
    async def flip(self, ctx, user : discord.Member=None):
        ...
        if user != None:
            ...
            if user.id == self.bot.user.id:
                ...
                msg = "Tính lật chụy hả cưng? Lật nè:\n\n"
    ...
    async def _8ball(self, *, question : str):
        ...
        await self.bot.say(General.bshuffle())
